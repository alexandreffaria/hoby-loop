  ...
  return (
    <div className="max-w-md mx-auto min-h-screen p-5 font-sans text-main-text">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-black uppercase bg-gradient-secondary-tertiary text-transparent bg-clip-text">{t('consumer.title')}</h1>
            ...
            <div key={sub.ID} className="p-1 rounded-2xl bg-gradient-secondary-forth">
              <div className="bg-background p-4 rounded-xl flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm text-gray-400">{t('common.status')} <span className="text-green-400 font-bold">{sub.status}</span></p>
                </div>
